...
if ( !empty( $tabs ) && !empty( $tabs[$current] ) ) : ?>
	<div class="user-info" id="learn-press-user-info">
		...
		<div class="user-basic-info">
			...
			<?php if ( $description = get_user_meta( $user->get_id(), 'description', true ) ): ?>
				<p class="user-bio"><?php echo get_user_meta( $user->get_id(), 'description', true ); ?></p>
			<?php endif; ?>
			<?php if ( $cuser->get_id() == $user->get_id() ): ?>
				<p>
