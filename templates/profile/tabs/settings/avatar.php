...
<form name="profile-avatar" method="post" enctype="multipart/form-data">
    ...
    <div id="lp-user-edit-avatar" class="lp-edit-profile lp-edit-avatar"
         data-custom="<?php echo $custom_img ? 'yes' : 'no'; ?>">
        <div id="profile-avatar-uploader" style="height: <?php echo $thumb_size['height']; ?>px;">
            <div class="lp-avatar-preview"
                ...
                <p id="lp-avatar-actions">
                    <a href="" id="lp-upload-photo"><i class="fas fa-upload"></i></a>
                    <!--		            <a href=""><i class="fas fa-plus"></i></a>-->
                    <!--		            <a href="" id="lp-save-remove-upload-photo"><i class="fas fa-check"></i></a>-->
                    <a href="" id="lp-remove-upload-photo"><i class="fas fa-times"></i></a>

                    <!--		            <button id="lp-upload-photo" type="button">-->
					<?php //_e( 'Upload', 'learnpress' ); ?><!--</button>-->
                    <!--		            <button id="lp-remove-upload-photo">-->
					<?php //_e( 'Remove', 'learnpress' ); ?><!--</button>-->
                    <!--		            <button id="lp-update">-->
					<?php //_e( 'Remove', 'learnpress' ); ?><!--</button>-->
                </p>
            </div>
...
<script type="text/html" id="tmpl-crop-user-avatar">
    <div class="lp-avatar-crop-image">
        ...
        <input type="hidden" name="lp-user-avatar-crop[nonce]"
               value="<?php echo wp_create_nonce( 'save-uploaded-profile-' . $user->get_id() ); ?>"/>
