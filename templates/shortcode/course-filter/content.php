...
$data = wp_parse_args(
	$data,
	array(
		'free_course_number'  => $count_courses_free,
		'paid_course_number'  => $count_courses_paid,
		...
		'intermediate_number' => $lp_course->get_courses( $lp_course->level_course_number( 'intermediate' ) ),
		'expert_number'       => $lp_course->get_courses( $lp_course->level_course_number( 'expert' ) ),
