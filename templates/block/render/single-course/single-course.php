...
<!-- wp:learnpress/course-detail-info -->
<!-- wp:learnpress/course-meta-primary {"className":"wp-block-learnpress-course-meta-primary"} -->
<!-- wp:learnpress/instructor-single-course {"avatar":true} /-->

<!-- wp:learnpress/categories-single-course /-->
<!-- /wp:learnpress/course-meta-primary -->

<!-- wp:learnpress/title-single-course {"tag":"h1"} /-->

<!-- wp:learnpress/course-meta-secondary -->
<!-- wp:learnpress/duration-single-course /-->
...
<!-- wp:learnpress/lp-content-area {"className":"wp-block-learnpress-lp-content-area"} -->
...
<!-- wp:learnpress/image-single-course /-->

<!-- wp:learnpress/price-single-course /-->
