...
<div class="course-results-progress">
    ...
    <div class="items-progress">
        ...
        <span class="number"><?php printf( __( '%d/%d', 'learnpress' ), $course_results['items']['lesson']['completed'], $course_results['items']['lesson']['total'] ); ?></span>
    ...
    <div class="items-progress">
        ...
        <span class="number" title="<?php esc_attr_e( sprintf( __( 'Failed %d, Passed %d', 'learnpress' ), $quiz_false, $course_results['items']['quiz']['passed'] ) ); ?>"><?php printf( __( '%d/%d', 'learnpress' ), $course_results['items']['quiz']['completed'], $course_results['items']['quiz']['total'] ); ?></span>
    </div>
