...
<div class="order-recover">
	<input type="text" name="order-key" value="<?php echo esc_attr( $order_key ); ?>" placeholder="<?php esc_html_e( 'Order key', 'learnpress' ); ?>">
	...
	<button type="button" class="lp-button button-recover-order" disabled="disabled"><?php esc_html_e( 'Recover', 'learnpress' ); ?></button>
</div>
