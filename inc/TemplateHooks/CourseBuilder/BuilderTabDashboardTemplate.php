	...
	private function render_statistics_cards( array $statistic, bool $is_admin ): string {
		...
		if ( $is_admin ) {
			...
			$cards[] = [
				...
				'color' => '#06AED4',
				'svg'   => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M16 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="8.5" cy="7" r="3"/><circle cx="18" cy="16" r="4"/><path d="M18 14v2l1.5 1"/></svg>',
			];
		}
