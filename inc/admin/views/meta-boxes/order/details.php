	...
	<div class="order-data">
		...
		<div class="order-data-field order-data-status <?php echo sanitize_title($order->get_post_status()); ?>">
			...
			<select name="order-status" data-status="<?php echo 'lp-' . $order->get_status(); ?>">
				...
				?>
					<option data-desc="<?php echo esc_attr(_learn_press_get_order_status_description($status)); ?>" value="<?php echo esc_attr($status); ?>" <?php echo selected($status, 'lp-' . $order->get_status(), false); ?>>
		...
		<div class="order-data-field order-data-user">
			<div class="order-users">
				<?php
				$data_user_id = json_encode($order->get_data('user_id'));
				...
				<select id="list-users" class="advanced-list" <?php esc_attr_e($disabled); ?> data-user-id="<?php esc_attr_e($data_user_id); ?>">
