...
class LP_Meta_Box_Course extends LP_Meta_Box {
	...
	public function general( $post_id ) {
		...
		$repurchase_option_desc  = sprintf( '1. %s', __( 'Reset course progress: The course progress and results of student will be removed.', 'learnpress' ) );
		$repurchase_option_desc .= '<br/>' . sprintf( '2. %s', __( 'Keep course progress: The course progress and results of student will remain.', 'learnpress' ) );
		$repurchase_option_desc .= '<br/>' . sprintf( '3. %s', __( 'Open popup: The student can decide whether their course progress will be reset with the confirm popup.', 'learnpress' ) );
