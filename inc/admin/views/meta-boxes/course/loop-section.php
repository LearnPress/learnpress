		...
		<?php if( $buttons = apply_filters( 'learn_press_loop_section_buttons', array() ) ):?>
			...
			<div class="lp-add-buttons">
				...
				<button class="button " id="add-lesson" type="button" data-action="add-lesson" data-type="lp_lesson">
					<?php _e( 'Select Lessons', 'learnpress' );?>
				</button>
				<button class="button " id="add-quiz" type="button" data-action="add-quiz" data-type="lp_quiz">
					<?php _e( 'Select Quizzes', 'learnpress' );?>
				</button>
				<!--
				<button id="learn-press-button-add-question" class="button" type="button"><?php _e( 'Select Lessons', 'learnpress' ); ?></button>
				<button id="learn-press-button-add-question" class="button" type="button"><?php _e( 'Select Quizzes', 'learnpress' ); ?></button>
				-->
			</div>
			<!--
