...
<tr <?php learn_press_admin_section_loop_item_class( $item, $section );?> data-text="<?php echo esc_attr($item->post_title);?>" data-item_id="<?php echo $item->item_id; ?>" data-section_item_id="<?php echo $item->section_item_id;?>" data-type="<?php echo $item->post_type; ?>">
	...
	<td class="section-item-input">
		...
		<input type="hidden" name="<?php echo $group_name; ?>[item_id]" value="<?php echo $item->item_id; ?>" />
