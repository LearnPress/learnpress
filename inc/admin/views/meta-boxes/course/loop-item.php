...
<li <?php learn_press_admin_section_loop_item_class( $item, $section );?> data-text="<?php echo esc_attr($item->post_title);?>" data-id="<?php echo $item->ID; ?>" data-type="<?php echo $item->post_type; ?>">
	...
	<input type="text" name="_lp_curriculum[__SECTION__][items][<?php echo $item->ID ? $item->ID : '__ITEM__';?>][name]" class="lp-item-name no-submit" data-field="item-name" value="<?php echo esc_attr( $item->post_title );?>" />
	<input type="hidden" name="_lp_curriculum[__SECTION__][items][<?php echo $item->ID ? $item->ID : '__ITEM__';?>][ID]" value="<?php echo $item->ID; ?>" />
	<input type="hidden" name="_lp_curriculum[__SECTION__][items][<?php echo $item->ID ? $item->ID : '__ITEM__';?>][item_id]" value="<?php echo $item->lp_si_ID; ?>" />
	<input type="hidden" class="lp-item-type" name="_lp_curriculum[__SECTION__][items][<?php echo $item->ID ? $item->ID : '__ITEM__';?>][post_type]" value="<?php echo $item->post_type; ?>" />
