	...
	<div class="modal-content">
		...
		<div class="content">
			<div class="ai-field">
				<div class="topic">
					<label
						for="ai-lesson-des-field-topic"><?php esc_html_e( 'Describe what make this lesson stand out', 'learnpress' ); ?></label>
					<textarea id="ai-lesson-des-field-topic" rows="5"
							  placeholder="<?php esc_attr_e( 'e.g.A lesson to teach how to use LearnPress', 'learnpress' ); ?>"></textarea>
				</div>
				<div class="audience">
					<label
						for="ai-lesson-des-field-audience"><?php esc_html_e( 'Audience', 'learnpress' ); ?></label>
					<?php
					$audience_options = $config->get( 'audiences', 'open-ai' );
					?>
					<select id="ai-lesson-des-field-audience" class="lp-tom-select" multiple>
						<?php
				...
				<div class="tone">
					<label for="ai-lesson-des-field-tone"><?php esc_html_e( 'Tone', 'learnpress' ); ?></label>
					<?php
					$tone_options = $config->get( 'tones', 'open-ai' );
					?>
					<select id="ai-lesson-des-field-tone" class="lp-tom-select" multiple>
						<?php
				...
				<div class="language">
					<label
						for="ai-lesson-des-field-language"><?php esc_html_e( 'Output Language', 'learnpress' ); ?></label>
					<?php
					$lang_options = $config->get( 'languages', 'open-ai' );
					?>
					<select id="ai-lesson-des-field-language" class="lp-tom-select" multiple>
						<?php
				...
				<div class="output">
					<div class="outputs">
						<label
							for="ai-lesson-des-field-outputs"><?php esc_html_e( 'Outputs', 'learnpress' ); ?></label>
						<input id="ai-lesson-des-field-outputs" type="number" min="1" step="1">
					</div>
					<button type="button"
							class="button"
							id="lp-generate-lesson-des-btn"><?php esc_html_e( 'Generate', 'learnpress' ); ?></button>
				</div>
			</div>
			<div class="ai-output">
				<header class="header">
