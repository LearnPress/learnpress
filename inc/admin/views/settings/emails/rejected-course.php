...
<p class="description">
	<?php _e( 'Settings for email when a course is rejected', 'learn_press' ); ?>
</p>
<table class="form-table">
	...
	<tr>
		<th scope="row">
			<label for="learn-press-emails-rejected-course-enable"><?php _e( 'Enable', 'learn_press' ); ?></label></th>
		<td>
	...
	<tr>
		<th scope="row">
			<label for="learn-press-emails-rejected-course-subject"><?php _e( 'Subject', 'learn_press' ); ?></label></th>
		<td>
	...
	<tr>
		<th scope="row">
			<label for="learn-press-emails-rejected-course-heading"><?php _e( 'Heading', 'learn_press' ); ?></label></th>
		<td>
	...
	<tr>
		<th scope="row">
			<label for="learn-press-emails-rejected-course-email-format"><?php _e( 'Email format', 'learn_press' ); ?></label>
		</th>
		<td>
			<?php learn_press_email_formats_dropdown( array( 'name' => $settings_class->get_field_name( 'emails_rejected_course[email_format]' ), 'id' => 'learn_press_email_formats', 'selected' => $settings->get( 'emails_rejected_course.email_format', $default ) ) ); ?>
		</td>
	</tr>
	<?php
