			...
			foreach ( $templates as $template_type => $title ) :
				...
				<div class="<?php echo join( ' ', $classes ); ?>">
					...
					<?php if ( ! $has_local_file ) : ?>
						...
						<?php endif; ?>
						<p class="description">
							<?php printf( __( 'To override and edit this email template copy <code>%1$s</code> to your theme folder: <code>%2$s</code>.', 'learnpress' ), plugin_basename( $template_file ), $theme_folder . '/' . $template_dir . '/' . $template ); ?>
						</p>
					<?php endif; ?>
				</div>
				<?php
