...
<script>
    (function (Vue, $store) {
        ...
        Vue.component('lp-quiz-choose-item', {
            template: 'tmpl-quiz-choose-item',
            props: ['item', 'added'],
            watch: {
                added: function () {
                    this.forceUpdate();
...
<script type="text/x-template" id="tmpl-lp-quiz-choose-items">
    <div id="lp-quiz-choose-items" :class="{show:show, loading: loading}">
        <div class="lp-choose-items" :class="{'show-preview': showPreview}">
            ...
            <div class="header">
                ...
                <ul class="tabs">
                    <li class="tab"><?php esc_html_e( 'Questions', 'learnpress' ); ?></li>
                </ul>
            ...
            <div class="main">
                <form class="search" @submit.prevent="">
                    <input placeholder="<?php esc_attr_e( 'Type here to search item', 'learnpress' ); ?>"
                           title="search" @input="onChangeQuery" v-mode="query">
                </form>
                <ul class="list-items">
            ...
            <div class="footer">
                <div class="cart">
                    ...
                    <button type="button" class="button button-primary edit-selected"
                            @click.prevent="showPreview = !showPreview" :disable="!addItems.length || adding">
                        {{editCartButton}}
                    </button>
