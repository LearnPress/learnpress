                    ...
                    <div class="<?php echo join( ' ', $classes ); ?>">
                        ...
                        <div class="<?php echo $has_local_file ? 'hide-if-js' : ''; ?>">
							<?php if ( $template_type == 'html' ): ?>
								...
								wp_editor(
									$content_html,
									'learn_press_emails_sdfsdf_' . $template_type,
									array(
										'textarea_rows' => 20,
										'wpautop'       => false,
										'textarea_name' => $field['field_name'] . '[html]'
										//emails_' . $this->id . '[email_content_html]' )
									)
								); ?>
							<?php else: ?>
                                <div class="editor">
                                    <textarea
                                            id="<?php echo esc_attr( 'learn_press_emails_dsdfdsfsdf' . $template_type ); ?>"
						...
						<?php if ( ! $has_local_file ): ?>
							<?php if ( $variables /*$this->get_variables_support() */): ?>
                                <p>
                                ...
                                <ol class="learn-press-email-variables<?php echo $template_type == 'html' ? ' has-editor' : ''; ?>"
                                    data-target="<?php echo esc_attr( 'learn_press_emails_sdfdsfdsfdf' . $template_type ); ?>">
