...
// Content
add_action( 'learn-press/course-content-summary', LP()->template( 'course' )->text( '<div class="course-detail-info"> <div class="lp-content-area"> <div class="course-info-left">' ), 10 );
...
add_action( 'learn-press/course-content-summary', LP()->template( 'course' )->text( '<div class="entry-content lp-content-area">' ), 30 );
...
add_action( 'learn-press/profile/orders', LP()->template( 'profile' )->callback( 'profile/tabs/orders/recover-order.php' ), 20 );
