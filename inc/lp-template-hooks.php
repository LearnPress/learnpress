...
add_action( 'learn_press_content_learning_summary', 'learn_press_course_title', 10 );
...
add_action( 'learn_press_content_learning_summary', 'learn_press_course_curriculum_popup', 65 );
