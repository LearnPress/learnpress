...
if ( ! class_exists( 'LP_Email_Completed_Order_Guest' ) ) {
	...
	class LP_Email_Completed_Order_Guest extends LP_Email {
		...
		public function __construct() {
			...
			$this->template_html  = 'emails/completed-order-guest.php';
			$this->template_plain = 'emails/plain/completed-order-guest.php';
