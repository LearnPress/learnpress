		...
		public function get_tabs() {
			...
			$this->_default_settings = array(
				'courses'       => array(
					...
					'priority' => 1,
					'icon'     => '<i class="lpicon-book-open"></i>',
				),
				'my-courses'    => array(
					...
					'priority' => 1,
					'icon'     => '<i class="lpicon-my-courses"></i>',
				),
				'quizzes'       => array(
					...
					'priority' => 20,
					'icon'     => '<i class="lpicon-puzzle-piece"></i>',
				),
				'orders'        => array(
					...
					'priority' => 25,
					'icon'     => '<i class="lpicon-shopping-cart"></i>',
				),
				'order-details' => array(
				...
				'settings'      => array(
					...
					'sections' => array(
						...
						'avatar'            => array(
							...
							'priority' => 20,
							'icon'     => '<i class="lpicon-user-circle"></i>',
						),
						'change-password'   => array(
							...
							'callback' => array( $this, 'tab_order_details' ),
							'priority' => 30,
							'icon'     => '<i class="lpicon-key"></i>',
						),
					),
					'priority' => 90,
					'icon'     => '<i class="lpicon-cog"></i>',
				),
				'logout'        => array(
					'title'    => esc_html__( 'Logout', 'learnpress' ),
					'slug'     => learn_press_profile_logout_slug(),
					'icon'     => '<i class="lpicon-sign-out-alt"></i>',
					'priority' => 100,
				),
			);
			...
			if ( 'yes' === self::get_option_publish_profile() ) {
				$this->_default_settings['settings']['sections']['privacy'] = array(
					...
					'priority' => 40,
					'callback' => array( $this, 'tab_order_details' ),
					'icon'     => '<i class="lpicon-user-secret"></i>',
				);
			}
