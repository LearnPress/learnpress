...
class CourseFaqsBlockType extends AbstractCourseBlockType {
	...
	public function render_content_block_template( array $attributes, $content, $block ): string {
		...
		try {
			...
			$html = $this->get_output_with_class_hash( $attributes, $html_faqs, [], [ 'font_size', 'font_weight', 'text_color', 'text_transform' ] );
		} catch ( Throwable $e ) {
	...
	public function get_inline_style( $attributes ) {
		$class_style               = '.' . $this->class_hash . ' div.course-faqs.course-tab-panel-faqs .course-faqs__title';
