...
if ( !class_exists( 'LP_Course_Post_Type' ) ) {
    ...
    final class LP_Course_Post_Type extends LP_Abstract_Post_Type {
        ...
        public static function admin_params() {
            global $post;
            return apply_filters( 'learn_press_admin_course_params', array(
                'id' => absint( $post->ID ),
        ...
        public static function register_post_type() {
            ...
            register_taxonomy( 'course_category', array( LP_COURSE_CPT ), array(
            ...
            register_taxonomy( 'course_tag', array( LP_COURSE_CPT ), array(
                'labels' => array(
        ...
        public function review_logs_meta_box() {
            add_meta_box(
                    'review_logs', __( 'Review Logs', 'learnpress' ), array( $this, 'review_logs_content' ), LP()->course_post_type, 'normal', 'default'
            );
        }
        ...
        private function _insert_section( $section = array() ) {
            ...
            $wpdb->insert(
                    $wpdb->learnpress_sections, $insert_data, array( '%s', '%d', '%d' )
            );
        ...
        public function _save() {
            ...
            if ( !empty( $_REQUEST['_lp_curriculum'] ) ) {
                ...
                foreach ( $_REQUEST['_lp_curriculum'] as $section_id => $_section ) {
                    ...
                    //allow create section without name/title
