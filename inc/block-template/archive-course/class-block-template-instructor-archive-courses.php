 ...
 */
class Block_Template_Instructor_Archive_Courses extends Abstract_Block_Template {
	public $slug                          = 'instructor-course-archive-course';
	public $name                          = 'learnpress/instructor-course-archive-course';
	...
	public $source_js                     = LP_PLUGIN_URL . 'assets/js/dist/blocks/instructor-course-archive-course.js';
	...
	public function render_content_block_template( array $attributes ) {
		...
		$output    = '{{instructor-course show_text="' . $show_text . '" is_link="' . $is_link . '" new_tab="' . $new_tab . '"}}';
		return $output;
	}
	...
	public function get_inline_style( $attributes ) {
		...
		return '.learn-press-courses .course-instructor-category > div:has(.course-instructor) {' . $border_classes_and_styles['styles'] . '}
				.learn-press-courses .course-instructor-category .course-instructor a {' . $link_classes_and_styles['style'] . '}
				.learn-press-courses div.course-instructor-category a:hover, .learn-press-courses div.course-instructor-category .course-instructor a:focus {' . $link_hover_classes_and_styles['style'] . '}
				';
	}
