...
class Block_Template_Requirements_Single_Course extends Abstract_Block_Template_Widget_Single_Course {
	...
	public function render_content_block_template( array $attributes ) {
		...
		echo sprintf(
			...
			SingleCourseTemplate::instance()->html_requirements( $course )
		);
	...
	public function get_inline_style( $attributes ) {
		...
		return '.lp-single-course .lp-single-course-main__left .course-requirements ul, 
		.lp-single-course .lp-single-course-main__left .course-requirements .extra-box__title 
