...
module.exports = {
    entry: {
        ...
        './assets/js/frontend/checkout': './assets/src/js/frontend/courses.js',
        './assets/js/frontend/become-teacher': './assets/src/js/frontend/courses.js',
        './assets/js/frontend/custom': './assets/src/js/frontend/courses.js',
        './assets/js/frontend/courses': './assets/src/js/frontend/courses.js',
        './assets/js/frontend/profile': './assets/src/js/frontend/courses.js',
        './assets/js/frontend/question-types': './assets/src/js/frontend/courses.js',
