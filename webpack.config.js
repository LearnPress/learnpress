...
module.exports = {
	...
	entry: {
		...
		'./assets/js/dist/blocks/course-search': './assets/src/apps/js/blocks/course-elements/course-search/index.js',
		'./assets/js/dist/blocks/course-order-by': './assets/src/apps/js/blocks/course-elements/course-order-by/index.js',
		'./assets/js/dist/blocks/course-filter': './assets/src/apps/js/blocks/course-filter/course-filter/index.js',
		'./assets/js/dist/blocks/course-search-filter': './assets/src/apps/js/blocks/course-filter/course-search-filter/index.js',
		'./assets/js/dist/blocks/course-author-filter': './assets/src/apps/js/blocks/course-filter/course-author-filter/index.js',
		'./assets/js/dist/blocks/course-level-filter': './assets/src/apps/js/blocks/course-filter/course-level-filter/index.js',
		'./assets/js/dist/blocks/course-price-filter': './assets/src/apps/js/blocks/course-filter/course-price-filter/index.js',
		'./assets/js/dist/blocks/course-categories-filter': './assets/src/apps/js/blocks/course-filter/course-categories-filter/index.js',
		'./assets/js/dist/blocks/course-tag-filter': './assets/src/apps/js/blocks/course-filter/course-tag-filter/index.js',
		'./assets/js/dist/blocks/button-submit-filter': './assets/src/apps/js/blocks/course-filter/button-submit-filter/index.js',
		'./assets/js/dist/blocks/button-reset-filter': './assets/src/apps/js/blocks/course-filter/button-reset-filter/index.js',
