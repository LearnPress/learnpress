		...
		apply_filters(
			...
			[
				...
				[
					...
					'id'      => 'lp_ai_assistant_summarize_enabled',
					'default' => 'yes',
					'type'    => 'checkbox',
				...
				[
					...
					'id'      => 'lp_ai_assistant_explain_enabled',
					'default' => 'yes',
					'type'    => 'checkbox',
					'desc'    => esc_html__( 'Allow learners to use the Explain Concept action.', 'learnpress' ),
				],
				[
					'title'   => esc_html__( 'Enable Mini Quiz', 'learnpress' ),
					'id'      => 'lp_ai_assistant_mini_quiz_enabled',
					'default' => 'yes',
					'type'    => 'checkbox',
					'desc'    => esc_html__( 'Allow learners to start and continue mini quizzes.', 'learnpress' ),
				],
				[
					'title'   => esc_html__( 'Enable Smart Review', 'learnpress' ),
					'id'      => 'lp_ai_assistant_smart_review_enabled',
					'default' => 'yes',
					'type'    => 'checkbox',
