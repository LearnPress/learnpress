...
- [LearnPress PRO Bundle](https://thimpress.com/product/learnpress-pro/) - LearnPress Premium Add-ons Bundle - Still LearnPress but in a PRO version with extreme power for an LMS WordPress Plugin.
- [LearnPress Semi-Pro Bundle](https://thimpress.com/product/learnpress-semi-pro-bundle/) - 5 Most Powerful as well as Most Wanted Premium LearnPress Add-ons with a big save compared to LearnPress Pro Bundle.
...
- [Memberships & Subscriptions add-on for LearnPress](https://thimpress.com/product/memberships-subscriptions-add-on-for-learnpress/) - Turn a LearnPress site into a membership-based course business with lifetime plans, recurring subscriptions, free trials, and plan-based course access.
- [Upsell add-on for LearnPress](https://thimpress.com/product/upsell-add-on-for-learnpress/) - Increase revenue by offering premium packages, bonus coupons, and exclusive features to elevate the learning experience for your students.
- [Certificates add-on for LearnPress](https://thimpress.com/product/certificates-add-on-for-learnpress/) - Add drag & drop certificates builder as well as select designed certificates templates for each LMS course, your student will get a particular certificate when they finish a course.
...
- [Assignments add-on for LearnPress](https://thimpress.com/product/assignments-add-on-for-learnpress/) - Assign tasks, essays to your students so they can do and submit at home. Instructors can check students' works after that and grade the assignments.
...
- [Stripe add-on for LearnPress](https://thimpress.com/product/stripe-add-on-for-learnpress/) - Stripe payment method for LearnPress WordPress LMS Plugin.
...
- [Live Course add-on for LearnPress](https://thimpress.com/product/live-course-add-on-for-learnpress/) - Create courses and live video meetings using Zoom or Google Meet by using shortcode to show the meeting content.
...
- [WPML add-on for LearnPress](https://thimpress.com/product/wpml-add-on-for-learnpress/) - The perfect solution for LearnPress users to translate anything flashily with the help from WPML.
...
- [Razorpay add-on for LearnPress](https://thimpress.com/product/razorpay-add-on-for-learnpress/) - Razorpay payment gateway with detailed reports and analytics related to payments for LearnPress.
- [Instamojo add-on for LearnPress](https://thimpress.com/product/instamojo-add-on-for-learnpress/) - Choose the Instamojo payment gateway to collect online payments, accept payment in rupees.
- [Paystack add-on for LearnPress](https://thimpress.com/product/paystack-add-on-for-learnpress/) - Payment can be done using Visa, Mastercard, Verve, USSD, mobile money, bank transfer, POS and more.
- [QPay add-on for LearnPress](https://thimpress.com/product/qpay-add-on-for-learnpress/) - Accept payments with bank transfers, mobile money designed specifically for Mongolian customers, and QR codes.
- [PayU add-on for LearnPress](https://thimpress.com/product/payu-add-on-for-learnpress/) - Receive payments via Credit and Debit Cards, Net Banking, Digital Wallets, Buy Now Pay Later, and more.
- [H5P add-on for LearnPress](https://thimpress.com/product/h5p/) - H5P offers over 70 different content types, including quizzes, presentations, simulations, drag-and-drop activities, and more.
...
- [Collections add-on for LearnPress](https://thimpress.com/product/collections-add-on-for-learnpress/) - Create LMS courses collection by select number of courses, this is helpful if you want to combine multiple LMS courses into a collection for a group of skills.
...
- [Student List add-on for LearnPress](https://thimpress.com/product/student-list-add-on-for-learnpress/) - Let people check the list of students who have signed up for the course. Choose to enable or disable student list for each course.
- [Coming Soon add-on for LearnPress](https://thimpress.com/product/coming-soon-add-on-learnpress/) - A great way to promote your course and make it easier for people to know about your brand new course.
- [LearnPress – Prerequisites Courses](https://thimpress.com/product/learnpress-prerequisites-courses/) - Require student to pass some courses in order to enroll other course.
- [LearnPress – Course Review](https://thimpress.com/product/learnpress-course-review/) - Review course for enrolled students.
- [LearnPress – Course Wishlist](https://thimpress.com/product/learnpress-course-wishlist/) - Add courses to a wishlist for students.
- [LearnPress – Export Import](https://thimpress.com/product/learnpress-export-import/) - Export or import course or courses out-of-box.
- [LearnPress – BuddyPress Integration](https://thimpress.com/product/learnpress-buddypress-integration/) - Add BuddyPress support for LearnPress WordPress LMS Plugin.
- [LearnPress – bbPress Integration](https://thimpress.com/product/learnpress-bbpress-integration/) - Add bbPress Forum support for LearnPress WordPress LMS Plugin.
- [LearnPress Add-on for Mobile App](https://thimpress.com/product/learnpress-mobile-app/) - Convert your current LearnPress websites to LMS Mobile App on both App Store and Google Play Store.
...
- SCORM Compliance & Package Support
- Gamification System
- Import Questions from CSV
- Headless LearnPress API Support
...
If you want to use LearnPress to build a Learning Management Website, please refer to our user guides in <a href="https://learnpresslms.com/?utm_source=WPORG&utm_medium=LP&utm_campaign=Content" target="_blank">LearnPress official site.</a>
...
You can find the REST API documentation <a href="https://learnpresslms.com/docs/learnpress-developer-documentation/" target="_blank">here</a>.
...
**Other note**
<a href="https://learnpresslms.com/docs/learnpress/" target="_blank">Documentation</a> is available in ThimPress site.
