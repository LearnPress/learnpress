...
export class BuilderEditCourse {
	...
	static selectors = {
		...
		// Scoped to .lp-cb-content to avoid catching popup buttons
		elBtnUpdateCourse: '.lp-cb-content .cb-btn-update',
		elBtnHeaderSave: '.lp-cb-save-btn',
		elBtnDraftCourse: '.lp-cb-content .cb-btn-darft',
		elBtnTrashCourse: '.lp-cb-content .cb-btn-trash',
		elBtnSaveSettings: '.cb-btn-save-settings',
		elDropdownToggle: '.lp-cb-content .cb-btn-dropdown-toggle',
		elDropdownMenu: '.lp-cb-content .cb-dropdown-menu',
		elHeaderActionsDropdown: '.lp-cb-content .cb-header-actions-dropdown',
		elTitleInput: '#title',
