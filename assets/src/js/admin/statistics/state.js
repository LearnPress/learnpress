 ...
 *
 * On every set() the four filters are written back to the URL (replaceState,
...
export class LpStatsState {
	...
	syncUrl() {
		...
		const { filtertype, date, instructor_id: instructorId, category_id: categoryId } = this.filters;
